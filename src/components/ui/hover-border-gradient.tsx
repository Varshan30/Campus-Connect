...
>) {
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-full border content-center bg-background/80 hover:bg-background/60 transition duration-500 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      )}
      {...props}
    >
      <div
        className={cn(
          "w-auto z-10 bg-background px-4 py-2 rounded-[inherit]",
          className
        )}
      >
        {children}
